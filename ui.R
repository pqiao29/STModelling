...
shinyUI(pageWithSidebar(
  ...
  mainPanel(
    ...
    tabsetPanel(tabPanel("Data", dataTableOutput("indata")), 
                ...
                tabPanel("Estimation", 
                         downloadButton("downEst", "Download as pdf"),
                         downloadButton("downEst_csv", "Download as csv"),
                         plotOutput("beta_plot", width = "100%")), 
                tabPanel("Selection", 
                         downloadButton("downSel_pdf", "Download as pdf"),
                         downloadButton("downSel_csv", "Download as csv"),
